...
<h2>Welcome to the iNet Output Tracking Development Portal</h2>
<p>Please use the navigation bar above to move around the site. In order to interact with the database, you will need a login. Please ask Rick!</p>
...
<h2><?php echo __d('cake_dev', 'Installation Checks for CakePHP %s.', Configure::version()); ?></h2>
...
<a href="http://cakephp.org/changelogs/2.0.0"><?php echo __d('cake_dev', 'Read the changelog'); ?> </a>
