<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/> [{if $phpload}] <link type="text/css" href="[{#s_base#}]/dbfacephp/css/load.php?load=db.css,te.css,c/thickbox.css,rview-common.css" rel="stylesheet"/><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/load.php?load=jquery.js,prototype.js,rview.js,thickbox.js,Utils.js,tommick.js,swfobject.js"></script> [{else}] <link type="text/css" media="all" rel="stylesheet" href="[{#s_base#}]/dbfacephp/css/db.css"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/te.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/c/thickbox.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/rview-common.css" rel="stylesheet"/><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/jquery.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/prototype.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/rview.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/thickbox.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/Utils.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/tommick.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/swfobject.js"></script> [{/if}] <script type="text/javascript">
      ...
      $('mainForm').request({ 
        ...
        onComplete: function(transport) {
          if (saveit) {
            ...
            $('chartprevdiv').show();
            var chart = new FusionCharts("[{#s_base#}]/dbfacephp/img/charts/icharts.swf", "flashobj", "600", "300", "0", "1");
    ...
    $j(document).ready(function() {
      ...
      $j.getJSON('[{#dbfacephp_base_url#}]/index.php?c=app&m=load_advrep', {appid: '[{$appid}]'}, function(json) {
    ...
    [{/if}]
  </script></head><body><div id="navcolumn" style="margin-left:5px;width:95%"><a href="[{#dbfacephp_base_url#}]/index.php?c=home&m=dashboard">[{ci_lang key='strDashboard'}]</a> ><a href="[{#dbfacephp_base_url#}]/index.php?c=app&m=create_step1">Application</a> > [{if $rpf=='tabular'}]Tabular Report[{elseif $rpf=='chart'}]Chart Report[{elseif $rpf=='summary'}]Summary Report[{elseif $rpf=='pivot'}]Matrix Report[{elseif $rpf=='calendar'}]Calendar Report[{/if}]</div><form name="mainForm" id="mainForm" method="POST" action="[{#dbfacephp_base_url#}]/index.php?c=app&m=advrep_preview"><input type="hidden" id="appid" name="appid" value="[{$appid}]"/><input type="hidden" id="rpf" name="rpf" value="[{$rpf}]"/> [{section name=i loop=$tablename}] <input type="hidden" name="tablename[]" value="[{$tablename[i]}]"/> [{/section}] [{section name=i loop=$left_columnname}] <input type="hidden" name="left_columnname[]" value="[{$left_columnname[i]}]"/> [{/section}] [{section name=i loop=$right_columnname}] <input type="hidden" name="right_columnname[]" value="[{$right_columnname[i]}]"/> [{/section}] [{section name=i loop=$jointype}] <input type="hidden" name="jointype[]" value="[{$jointype[i]}]"/> [{/section}] </form><table width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:2px;margin-left:5px;width:95%"><tbody><tr><td width="1" valign="top"><img width="1" src="[{#s_base#}]/dbfacephp/img/1px_trans.gif"/></td><td valign="top" style="width:192px">[{include file="advrep_clist.tpl"}]</td><td valign="top"><div><div elname="workAreaParent"><div elname="graphFieldHolder"><div elname="dropAreaPanel"><table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td width="33px" elname="graphButton" onclick="javascript:switchView(this);" id="ZDBSummarySelEl" class="graphSelSummaryView"><img width="33px" src="[{#s_base#}]/dbfacephp/img/1px_trans.gif"/></td><td valign="top" style="padding-top: 5px; padding-bottom: 3px;" class="dropAreaBG" rowspan="2"> [{include file="advrep_filter.tpl"}] [{include file="advrep_summary.tpl"}] </td><td class="dropAreaRightBG" rowspan="2"></td></tr><tr><td class="filterDesel" elname="filterButton" onclick="javascript:switchView(this);" id="ZDBFilterSelEl"></td></tr></tbody></table></div></div><div elname="workArea">[{include file="advrep_help.tpl"}]</div><div class="showGraphRefresh" onclick="javascript:analyticsReport();" id="ZDBAnalysisRefresh">Click Here to Generate Report</div></div></div></td></tr></tbody></table><span id="template_dropview" style="display:none"><div dragfield='true' class="zdbdragfield" columntype="#{columntype}" columnname="#{columnname}"><table width="193px" height="20" cellspacing="0" cellpadding="0" align="left"><tbody><tr><td width="10" height="19" class="dragelementleft" style="cursor: pointer;"/><td width="70" nowrap="nowrap" height="19" align="left" elname="fieldName" class="dragElBG">#{displayname}</td><td width="15" valign="middle" nowrap="nowrap" height="19" align="left" class="fx"></td><td valign="middle" align="left" class="dragElBG"><table cellspacing="0" cellpadding="0" align="right" class="dragElFuncBg" menuparent="true"><tbody><tr><td nowrap="nowrap" elname="operation" onclick="javascript:showMenu(this,event)" class="dragElOperation">#{fx}</td><td width="10px" valign="middle" nowrap="nowrap" height="13px" align="left" onclick="javascript:$j(this).prev('td').trigger('click');"><img width="8px" height="10px" class="dropDownMenuImg" src="[{#s_base#}]/dbfacephp/img/1px_trans.gif"/></td></tr></tbody></table></td><td valign="middle" align="center" style="cursor: pointer;" onclick="javascript:removeDragFieldEl(this,event)" class="dragElClose"/></tr></tbody></table></div></span>
[{include file="advrep_menu.tpl"}]
[{include file="inc/loading.tpl" loadingmsg='Generating Report, please wating...' width='250px'}]
[{include file="aw_reportpro.tpl"}]
