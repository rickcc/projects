<html><head><meta http-equiv='content-type' content='text/html;charset=UTF-8'/> [{if $phpload}] <link type="text/css" href="[{#s_base#}]/dbfacephp/css/load.php?load=style-default.css,te.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/c/thickbox.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/c/theme.css" rel="stylesheet"/><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/load.php?load=tommick.js,Utils.js,rview.js,jquery.js,thickbox.js,prototype.js,calendar.js,calendar-en.js,calendar-setup.js"></script> [{else}] <link type="text/css" href="[{#s_base#}]/dbfacephp/css/style-default.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/te.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/c/thickbox.css" rel="stylesheet"/><link type="text/css" href="[{#s_base#}]/dbfacephp/css/c/theme.css" rel="stylesheet"/><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/tommick.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/Utils.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/rview.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/jquery.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/thickbox.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/prototype.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/calendar.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/calendar-en.js"></script><script type="text/javascript" src="[{#s_base#}]/dbfacephp/js/calendar-setup.js"></script> [{/if}] <style type="text/css">.fixPopTable{display:block;overflow:auto;height:300px;width:100%;}</style><script type="text/javascript">
  ...
  function deleteresultrow(rowNo) {
    ...
    document.mainForm.action="[{#dbfacephp_base_url#}]/index.php?c=rowdelete&";
    var table=document.getElementById('databody');
    var pkColumnNames = new Array();
    [{section name=i loop=$pkColumnNames}]
    pkColumnNames[[{$smarty.section.i.index}]]="[{$pkColumnNames[i]}]";
    document.mainForm.action+="&pkColumnNames[]="+"[{$pkColumnNames[i]}]";
    [{/section}]
    ...
    document.mainForm.action="[{#dbfacephp_base_url#}]/index.php?c=viewtablej";
  }
  ...
  function updateresultDetail() {
    ...
    [{section name=i loop=$pkColumnNames}]
    pkColumnNames[[{$smarty.section.i.index}]]="[{$pkColumnNames[i]}]";
    document.te_rowform_change.action+="&pkColumnNames[]="+"[{$pkColumnNames[i]}]";
    [{/section}]
    ...
    document.te_rowform_change.action="[{#dbfacephp_base_url#}]/index.php?c=rowupdate";
  }
  ...
  function openblob(requestID, argRow, argColumn) {
    ...
    var href = "[{#dbfacephp_base_url#}]/index.php?c=viewtablej&viewName=employees"
...
　  }
    ...
    selElement.onchange=function(){
      ...
      [{section name=i loop=$pkColumnNames}]
      pkColumnNamesData +="&pkColumnNames[]=[{$pkColumnNames[i]}]";
      pkColumnNames[[{$smarty.section.i.index}]]="[{$pkColumnNames[i]}]";
      [{/section}]
      ...
      var url = "[{#dbfacephp_base_url#}]/index.php?c=columnupdate&viewname=[{$viewname}]&dbname=[{$dbname}]"
        +"&columnNo="+(argColumn-1)
  ...
  function set_pickdt_url(ele) {
    ...
    je.attr('href', ROOT_URL+'?c=req&m=columndata&columnname=[{$viewname}].'+columnname+'&width=350&height=300');
  }
  ...
  function renew_filter_bookmarks() {
    $j.getJSON("[{#dbfacephp_base_url#}]/index.php?c=req&m=getbookmarks&cat=filter&subcat=[{$viewname}]",
    function(json) {
  ...
  function get_bookmark(bkid) {
    $j.getJSON("[{#dbfacephp_base_url#}]/index.php?c=req&m=getbookmark", {bkid: bkid}, function(json) {
      resetFilters();
  ...
  function delfilterbookmark(bkid) {
    var cat = 'filter';
    var subcat='[{$viewname}]';  
    $j.getJSON("[{#dbfacephp_base_url#}]/index.php?c=req&m=delfilterbookmark", {bkid: bkid, cat:cat, subcat: subcat}, function(json) {
      set_filter_bookmarks(json);
    });   
  }  
  ...
  function save_bookmark() {
    ...
    $j.getJSON('[{#dbfacephp_base_url#}]/index.php?c=req&m=savefilterbookmark&'+f, {cat:cat, subcat: subcat, catkey:filtername}, function(data){
  ...
  function save_query_app() {
    ...
    var f = $('mainForm').serialize();
    $j.getJSON('[{#dbfacephp_base_url#}]/index.php?c=viewtable&m=saveapp&'+f, {appname:appname, apptitle: apptitle, appdesc:appdesc}, function(json){
...
</script></head><body><div id="bodyColumn"><div id="navcolumn"><a href="[{#dbfacephp_base_url#}]/index.php?c=home&m=dashboard">[{ci_lang key='strDashboard'}]</a> > [{ci_lang key='strYouVisit'}]: [{$viewname}]<span><a href="javascript:parent.frames.content.window.print();"><img src="[{#s_base#}]/dbfacephp/img/print.png" style="vertical-align:middle"/></a>&nbsp;&nbsp;</span></div><div id="TmMsgDiv" style="position:absolute;z-index:500;left:5px;top:0px;width:90%;display:none;"><div style="position:absolute;left:5px;top:0px;"><input type="button" class="messageclose" style="border:0px;cursor:pointer;width:9px;height:9px;" onclick="TmMsgBox.hideError('navcontent');"></div><table class="borderbrown" cellpadding="3" cellspacing="5" height="40px" border="0"><tr class="errcellbottombdr"><td width="25px" id="msgicon" class="successicon"></td><td id="err" align="right" class="infomessage" style="border:0;background:none">Error Message Here</td></tr></table></div><div id="pagebanner">
[{include file="pagebanner.tpl"}]
</div></div><form action="[{#dbfacephp_base_url#}]/index.php?c=viewtable" method="post" id="mainForm" name='mainForm'><input type="hidden" name="dbname" value="[{$dbname}]"><input type="hidden" name="viewname" value="[{$viewname}]"><input type="hidden" name="orderColumnName" value=""><input type="hidden" name="orderMethod" value=""><input type="hidden" name="pageNo" value=""><input type="hidden" name="rowNo" value=""><input type="hidden" name="downloadType" value=""><input type="hidden" name="filterDisplay" value="none"><div id="moreFilterDialog" style="display:none;width:50%;margin-top:10px;"><table border="0" cellpadding="0" cellspacing="0" class="popdialog1" id="filter_table"><tbody id="filter_body"><tr id="filter_row0"><td style="text-align:center;align:center" nowrap><select name="sqlcondition[]" class="config-picklist"> [{section name=i loop=$fields}] <option value="[{$fields[i].name}]">[{$fields[i].name}]</option> [{/section}] </select><select name="sqlop[]" class="config-picklist" onchange="javascript:change_operator(this);"><option value="=">equals</option><option value=">">greater than</option><option value=">=">greater or equal</option><option value="<">less than</option><option value="<=">less or equal</option><option value="<>">not equal to</option><option value="like">contains</option><option value="not like">does not contain</option><option value="in">includes</option><option value="not in">not includes</option><option value="between">between</option><option value="not between">not between</option><option value="is null">is null</option><option value="is not null">is not null</option><option value="ignore" selected>--No Filter--</option></select><input type="text" name="sqlvalue[]" class="config-textfield" value=""><select name="sqljoin[]" class="config-picklist"><option value="and" selected>and</option><option value="or">or</option></select><a class="thickbox" renewhref="set_pickdt_url"><img src="[{#s_base#}]/dbfacephp/img/pickdt.gif" alt="Pick distinct data from table" title="Pick distinct data from table" align="absmiddle"/></a><a href="javascript:;" onclick="javascript:addCondition();"><img src="[{#s_base#}]/dbfacephp/img/add2.gif" alt="add new condition." title="add new condition." align="absmiddle"/></a><a href="javascript:;" onclick="javascript:delFilter(this);"><img src="[{#s_base#}]/dbfacephp/img/delete2.gif" alt="Remove the condition." title="Remove the condition." align="absmiddle"/></a></td></tr><tr id="filter_button"><td style="text-align:center;align:center" nowrap><input type="button" class="input-submit" onclick="javascript:sv_filter();" value="Apply"/><input type="button" class="input-submit gray" onclick="DisplayMenu('moreFilterDialog', 'groupSelect');document.mainForm.filterDisplay.value='none';" value="Close"/><div id="gbar" class="gb1"><a href="javascript:;" style="font-size:10px" onclick="return showScriptMenu(this, event);">Bookmarks&#9660</a><div class="gbard" id="gbarif" style="border:0;z-index:1"></div><div class="gbard" id="gbardd" style="text-align:left" onclick="javascript:close(event);"></div></div><a style="valign:bottom" href="javascript:resetFilters();sv_filter();" class="subopen">clear all filters</a></td></tr></tbody></table></div></form><div id="te_container" class="borderbrown" style="overflow:auto;width:100%;height:80%;_height:400px;display:block;" cellpadding="0" cellspacing="0">
[{include file="datagrid.tpl"}]
</div><div class="exportlinks">[{ci_lang key='strExportOptions'}]: <a href="javascript:showDownloadOption('csv');"><span class="export csv">CSV </span></a>| <a href="javascript:showDownloadOption('xls');"><span class="export excel">Excel </span></a>| <a href="javascript:showDownloadOption('xml');"><span class="export xml">XML </span></a>| <a href="javascript:showDownloadOption('html');"><span class="export html">HTML </span></a>| <a href="javascript:showDownloadOption('pdf');"><span class="export pdf">PDF </span></a></div></div><form action="[{#dbfacephp_base_url#}]/index.php?c=viewtablej" method="post" name="te_rowform"><input type="hidden" name="rowNo" value=""/></form><div id="te_rowdetail" style="display:none;position:absolute;z-index:1000"><table id="te_rowdetail_head" cellpadding="0" cellspacing="0" style="margin:0px;border-bottom:0px;width:100%"><thead onMouseDown="catchFlyBar(event, 'te_rowdetail')" onMouseUp="releaseFlyBar(event)"><tr ondblclick="unFreezeBackground();DisplayMenu('te_rowdetail', 'groupSelect')" align="right"><td width="80%">&nbsp;</td><td width="5%" align="right" valign="bottom"><a href="javascript:;" onClick="javascript:unFreezeBackground();DisplayMenu('te_rowdetail', 'groupSelect');" class="close">&nbsp;</a></td></tr></thead></table><div id="te_rowdetail_tb_div"><table id="te_rowdetail_tb" border="0" cellpadding="0" cellspacing="0" class="popdialog1"><tbody><tr><td colspan="3"></td></tr> [{section name=i loop=$fields}] <tr><td width="5px">&nbsp;</td><td class="bodyTextBold" style="width:5%" nowrap>[{$fields[i].name}]:</td><td>&nbsp;</td></tr> [{/section}] <tr height="10px"><td colspan="3"></td></tr></tbody></table></div><table id="te_rowdetail_button" border="0" cellpadding="0" cellspacing="5" class="popdialog1"><tr><td colspan="4"><center><input type="button" class="input-submit" value="Change" onclick="javascript:showPage('changeresultdetail', document.te_rowform.rowNo.value);"/><input type="button" class="input-submit gray" value="Cancel" onclick="javascript:closeLayer();"/></center></td></tr></table></div><div id="te_rowchange" style="display:none;position:absolute;z-index:1000;"><form action="[{#dbfacephp_base_url#}]/index.php?c=rowupdate" method="post" id="te_rowform_change" name="te_rowform_change"><input type="hidden" name="dbname" value="[{$dbname}]"><input type="hidden" name="viewname" value="[{$viewname}]"><table id="te_rowchange_head" cellpadding="0" cellspacing="0" style="margin:0px;border-bottom:0px;width:100%"><thead onMouseDown="catchFlyBar(event, 'te_rowchange')" onMouseUp="releaseFlyBar(event)"><tr ondblclick="unFreezeBackground();DisplayMenu('te_rowchange', 'groupSelect')"><td width="80%">&nbsp;</td><td width="5%" align="right" valign="bottom"><a href="javascript:;" onClick="javascript:unFreezeBackground();DisplayMenu('te_rowchange', 'groupSelect');" class="close">&nbsp;</a></td></tr></thead></table><div id="te_rowchange_tb_div"><table id="te_rowchange_tb" border="0" cellpadding="0" cellspacing="0" class="popdialog1"><tbody><tr><td colspan="3"></td></tr> [{section name=i loop=$fields}] <tr><td width="5px">&nbsp;</td><td class="bodyTextBold" nowrap>[{$fields[i].name}]:<input type="hidden" name="keyColumns[]" value="[{$fields[i].name}]"/></td><td nowrap><input type="checkbox" name="keyChecks_" style="vertical-align:middle;margin:1px"/> [{if $fields[i].type==$smarty.const.CDT_TEXTAREA}] <textarea class="config-textarea" name="keyValues[]" cols="40" style="font-size:10px;height:48px;" onchange="javascript:setChecked(this);"></textarea> [{elseif $fields[i].type==$smarty.const.CDT_DATETIME}] <input type="text" class="config-textfield" id="keyValues[{$smarty.section.i.index}]" name="keyValues[]" size="36" onchange="javascript:setChecked(this);"/><a href="javascript:;" onmouseover="javascript:setupCalendar('keyValues[{$smarty.section.i.index}]');"><img id="c_keyValues[{$smarty.section.i.index}]" src='[{#s_base#}]/dbfacephp/img/form/date_icon.gif' width='16' height='17' border='0' title='Insert Date' style='vertical-align:middle;'/></a> [{elseif $fields[i].type==$smarty.const.CDT_NUMBERIC}] <input type="text" class="config-textfield" name="keyValues[]" size="40" onkeypress="return checkNumberic(event);" onchange="javascript:setChecked(this);"/> [{elseif $fields[i].type==$smarty.const.CDT_DECIMAL}] <input type="text" class="config-textfield" name="keyValues[]" size="40" onkeypress="return checkDecimal(event);" onchange="javascript:setChecked(this);"/> [{else}] <input type="text" class="config-textfield" name="keyValues[]" size="40" style="vertical-align:middle;" onchange="javascript:setChecked(this);"/> [{/if}] </td></tr> [{/section}] <tr height="20px"><td colspan="3"></td></tr></tbody></table></div><table id="te_rowchange_button" border="0" cellpadding="0" cellspacing="5" class="popdialog1"><tr><td colspan="5"><center><input type="button" class="input-submit" value="Change" onclick="javascript:updateresultDetail();"/><input type="button" class="input-submit gray" value="Cancel" onclick="javascript:closeLayer();"/></center></td></tr></table></form></div><div id="te_rowinsert" style="display:none;position:absolute;z-index:1000;"><form action="[{#dbfacephp_base_url#}]/index.php?c=rowinsert" method="post" id="te_rowform_insert" name="te_rowform_insert"><input type="hidden" name="dbname" value="[{$dbname}]"/><input type="hidden" name="viewname" value="[{$viewname}]"/><table id="te_rowinsert_head" cellpadding="0" cellspacing="0" style="margin:0px;border-bottom:0px;width:100%;"><thead onMouseDown="catchFlyBar(event, 'te_rowinsert')" onMouseUp="releaseFlyBar(event)"><tr ondblclick="unFreezeBackground();DisplayMenu('te_rowinsert', 'groupSelect')"><td width="80%">&nbsp;</td><td width="5%" align="right" valign="bottom"><a href="javascript:;" onClick="javascript:unFreezeBackground();DisplayMenu('te_rowinsert', 'groupSelect');" class="close">&nbsp;</a></td></tr></thead></table><div id="te_rowinsert_tb_div"><table id="te_rowinsert_tb" border="0" cellpadding="0" cellspacing="0" class="popdialog1"><tbody><tr><td colspan="3"></td></tr> [{section name=i loop=$fields}] <tr><td width="5px">&nbsp;</td><td class="bodyTextBold" nowrap>[{$fields[i].name}]:<input type="hidden" name="columnNames[]" value="[{$fields[i].name}]"/></td><td nowrap><input type="checkbox" name="keyChecks_" style="vertical-align:middle;margin:1px" onclick="javascript:field_setnull(this);"/> [{if $fields[i].type==$smarty.const.CDT_TEXTAREA}] <textarea class="config-textarea" name="keyValues[]" cols="40" style="font-size:10px;height:48px;" onchange="javascript:setChecked(this);"></textarea> [{elseif $fields[i].type==$smarty.const.CDT_DATETIME}] <input type="text" class="config-textfield" name="keyValues[]" id="i_keyValues[{$smarty.section.i.index}]" size="46" onchange="javascript:setChecked(this);"/><a href="javascript:;" onmouseover="javascript:setupCalendar4('i_keyValues[{$smarty.section.i.index}]');"><img id="b_i_keyValues[{$smarty.section.i.index}]" src='[{#s_base#}]/dbfacephp/img/form/date_icon.gif' width='16' height='17' border='0' title='Insert Date' style='vertical-align:middle;'/></a> [{elseif $fields[i].type==$smarty.const.CDT_NUMBERIC}] <input type="text" class="config-textfield" name="keyValues[]" size="40" onkeypress="return checkNumberic(event);" onchange="javascript:setChecked(this);"/> [{elseif $fields[i].type==$smarty.const.CDT_DECIMAL}] <input type="text" class="config-textfield" name="keyValues[]" size="40" onkeypress="return checkDecimal(event);" onchange="javascript:setChecked(this);"/> [{else}] <input type="text" class="config-textfield" name="keyValues[]" size="40" style="vertical-align:middle;" onchange="javascript:setChecked(this);"/> [{/if}] </td></tr> [{/section}] <tr height="20px"><td colspan="3"></td></tr></tbody></table></div><table id="te_rowinsert_button" border="0" cellpadding="0" cellspacing="5" class="popdialog1"><tr><td colspan="5"><center><input type="button" class="input-submit" value="Insert" onclick="javascript:insertresultDetail();"/><input type="button" class="input-submit gray" value="Cancel" onclick="javascript:closeLayer();"/></center></td></tr></table></form></div>
[{include file="exportoption.tpl"}]
<div id="div_bookmark_name" style="display:none;position:absolute;z-index:1000;"><form action="[{#dbfacephp_base_url#}]/index.php?c=export" name="f_bookmark_name" id="f_bookmark_name" method="post"><table id="bookmark_name_head" cellpadding="0" cellspacing="0" style="margin:0px;border-bottom:0px;width:100%;"><thead onMouseDown="catchFlyBar(event, 'div_bookmark_name')" onMouseUp="releaseFlyBar(event)"><tr ondblclick="unFreezeBackground();DisplayMenu('div_bookmark_name', 'groupSelect')"><td width="80%"><strong></strong></td><td width="5%" align="right" valign="bottom"><a href="javascript:;" onClick="javascript:unFreezeBackground();DisplayMenu('div_bookmark_name', 'groupSelect');" class="close">&nbsp;</a></td></tr></thead></table><div id="bookmark_name_tb_div"><table id="bookmark_name_tb" border="0" cellpadding="0" cellspacing="0" class="popdialog1" style="padding-left:15px"><tbody><tr><td colspan="2"></td></tr><tr><td class="bodyTextBold"><label for="filtername">Filter name:</label></td><td><input type="text" class="config-textfield" size="30" id="filtername" name="filtername" value=""/></td></tr></tr><tr height="20px"><td colspan="2"></td></tr></tbody></table></div><table id="bookmark_name_button" border="0" cellpadding="0" cellspacing="5" class="popdialog1"><tr><td colspan="5"><center><input type="button" class="input-submit" value="Save" onclick="javascript:save_bookmark();closeLayer();"/><input type="button" class="input-submit gray" value="Cancel" onclick="javascript:closeLayer();"/></center></td></tr></table></form></div><div id="div_quick_app" style="display:none;position:absolute;z-index:1000;"><form action="[{#dbfacephp_base_url#}]/index.php?c=export" name="f_div_quick_app" id="f_div_quick_app" method="post"><table id="div_quick_app_head" cellpadding="0" cellspacing="0" style="margin:0px;border-bottom:0px;width:100%;"><thead onMouseDown="catchFlyBar(event, 'div_quick_app')" onMouseUp="releaseFlyBar(event)"><tr ondblclick="unFreezeBackground();DisplayMenu('div_quick_app', 'groupSelect')"><td width="80%"><strong></strong></td><td width="5%" align="right" valign="bottom"><a href="javascript:;" onClick="javascript:unFreezeBackground();DisplayMenu('div_quick_app', 'groupSelect');" class="close">&nbsp;</a></td></tr></thead></table><div id="div_quick_app_tb_div"><table id="div_quick_app_tb" border="0" cellpadding="0" cellspacing="0" class="popdialog1" style="padding-left:15px"><tbody><tr><td colspan="2"></td></tr><tr><td class="bodyTextBold"><label for="filtername">Application name:</label></td><td><input type="text" class="config-textfield" size="30" id="appname" name="appname" value=""/></td></tr></tr><tr><td class="bodyTextBold"><label for="filtername">Application Title:</label></td><td><input type="text" class="config-textfield" size="30" id="apptitle" name="apptitle" value=""/></td></tr></tr><tr><td class="bodyTextBold"><label for="filtername">Application Description:</label></td><td><textarea class="config-textarea" rows="4" style="width:100%" name="appdesc" id="appdesc"></textarea></td></tr></tr><tr height="20px"><td colspan="2"></td></tr></tbody></table></div><table id="div_quick_app_button" border="0" cellpadding="0" cellspacing="5" class="popdialog1"><tr><td colspan="5"><center><input type="button" class="input-submit" value="Save" onclick="javascript:save_query_app();"/><input type="button" class="input-submit gray" value="Cancel" onclick="javascript:closeLayer();"/></center></td></tr></table></form></div>
[{include file="inc/loading.tpl" loadingmsg="Loading data, please wait..."}]
</body></html>